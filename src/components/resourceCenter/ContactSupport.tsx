...
import { ArrowLeft, Paperclip, Send, MessageSquare } from 'lucide-react';
  ...
  if (!chatStarted) {
    return (
      <div className="flex flex-col items-center justify-center h-full p-8 text-center">
        ...
        <Button onClick={() => setChatStarted(true)} className="gap-2">
          Send us a message
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center gap-3 px-4 py-3 border-b border-border">
        <TooltipProvider delayDuration={300}>
          <Tooltip>
            <TooltipTrigger asChild>
              <Button variant="ghost" size="icon" className="h-8 w-8" onClick={() => setChatStarted(false)}>
        ...
        <span className="text-sm text-muted-foreground">Otto Notes Support</span>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        <div className="flex gap-2">
          ...
          <div className="bg-muted rounded-lg p-3 max-w-[85%]">
            <p className="text-xs font-medium text-muted-foreground mb-1">Otto Notes Support</p>
            <p className="text-sm">
        ...
        <div className="bg-muted rounded-lg p-4 space-y-3">
          ...
          <div className="flex items-center justify-between">
            ...
            <Button size="sm" onClick={handleSendEmail}>Send</Button>
          </div>
        </div>
      </div>
