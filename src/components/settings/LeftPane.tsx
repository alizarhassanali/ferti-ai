...
export const LeftPane = () => {
  ...
  return <>
      ...
      <button onClick={() => setIsMobileMenuOpen(true)} className="md:hidden fixed top-4 left-4 z-40 p-2.5 rounded-xl bg-[hsl(38_35%_96%)] text-[hsl(25_30%_35%)] hover:bg-[hsl(38_30%_92%)] shadow-[0_2px_8px_rgba(0,0,0,0.08)] transition-all" aria-label="Open menu">
        <Menu className="h-5 w-5" />
      </button>

      {/* Mobile Backdrop */}
      {isMobileMenuOpen && <div className="md:hidden fixed inset-0 bg-[hsl(25_30%_15%)/40] backdrop-blur-sm z-40 transition-opacity duration-300" onClick={() => setIsMobileMenuOpen(false)} />}
      ...
      `}>
        {/* Mobile Close Button */}
        <button onClick={() => setIsMobileMenuOpen(false)} className="md:hidden absolute top-5 right-4 z-10 p-2 rounded-xl hover:bg-[hsl(38_30%_90%)] text-[hsl(25_20%_50%)] hover:text-[hsl(25_30%_30%)] transition-all" aria-label="Close menu">
          <X className="h-5 w-5" />
        </button>
        ...
        <nav className={`flex-1 overflow-y-auto ${isCollapsed ? 'px-2 py-4' : 'px-4 py-5'}`}>
          <ul className="space-y-1">
            ...
            if (item.type === 'header') {
              return !isCollapsed ? <li key={item.label} className="px-3 pt-4 pb-2 text-[10px] font-semibold text-[hsl(25_20%_55%)] uppercase tracking-[0.1em]">
                    {item.label}
                  </li> : <li key={item.label} className="h-px bg-[hsl(35_20%_90%)] my-3" />;
            }
            ...
            const displayLabel = item.isToggleable && isSessionsPage ? isSessionsListVisible ? 'Hide sessions' : 'View sessions' : item.label;
            const ArrowIcon = item.isToggleable && isSessionsPage ? isSessionsListVisible ? ChevronLeft : ChevronRight : null;
            const handleClick = () => {
                      ...
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <button onClick={handleClick} className={`
                              ...
                              ${isActive ? 'bg-[hsl(35_40%_90%)] text-[hsl(12_45%_35%)] shadow-[0_2px_6px_rgba(0,0,0,0.06)]' : 'text-[hsl(25_20%_40%)] hover:bg-[hsl(38_30%_92%)] hover:text-[hsl(25_30%_25%)]'}
                            `}>
                            <div className={`
                              flex items-center justify-center w-9 h-9 rounded-xl transition-all duration-200
                              ${isActive ? 'bg-[hsl(12_45%_35%)] text-white shadow-[0_2px_8px_rgba(139,69,61,0.25)]' : 'bg-[hsl(38_25%_93%)] group-hover:bg-[hsl(38_30%_88%)] group-hover:scale-105'}
                            `}>
                        ...
                        transition-all duration-200 group
                        ${isActive ? 'bg-[hsl(35_40%_90%)] text-[hsl(12_45%_35%)] font-semibold shadow-[0_2px_6px_rgba(0,0,0,0.06)]' : 'text-[hsl(25_20%_40%)] hover:bg-[hsl(38_30%_92%)] hover:text-[hsl(25_30%_25%)] font-medium'}
                      `}>
                      <div className={`
                        flex items-center justify-center w-8 h-8 rounded-lg transition-all duration-200
                        ${isActive ? 'bg-[hsl(12_45%_35%)] text-white shadow-[0_2px_8px_rgba(139,69,61,0.25)]' : 'bg-transparent group-hover:scale-105'}
                      `}>
                        <Icon className="h-[18px] w-[18px]" strokeWidth={isActive ? 2.5 : 1.75} />
                      </div>
                      ...
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <button onClick={handleClick} className={`
                              w-full flex items-center justify-center p-2.5 rounded-xl text-sm
                              transition-all duration-200 group
                              ${isReferral ? 'text-[hsl(142_60%_35%)]' : isActive ? 'bg-[hsl(35_40%_90%)] text-[hsl(12_45%_35%)]' : 'text-[hsl(25_15%_55%)] hover:bg-[hsl(38_30%_92%)] hover:text-[hsl(25_25%_40%)]'}
                            `}>
                            <div className={`
                              flex items-center justify-center w-9 h-9 rounded-xl transition-all duration-200
                              ${isReferral ? 'bg-[hsl(142_50%_94%)] group-hover:bg-[hsl(142_50%_88%)]' : 'bg-[hsl(38_25%_94%)] group-hover:bg-[hsl(38_30%_88%)] group-hover:scale-105'}
                            `}>
                        ...
                        w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm
                        transition-all duration-200 group
                        ${isReferral ? 'text-[hsl(142_60%_32%)] hover:bg-[hsl(142_50%_94%)] font-medium' : isActive ? 'bg-[hsl(35_40%_90%)] text-[hsl(12_45%_35%)] font-semibold' : 'text-[hsl(25_15%_50%)] hover:bg-[hsl(38_30%_92%)] hover:text-[hsl(25_25%_35%)] font-medium'}
                      `}>
