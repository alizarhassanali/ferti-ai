...
const NewSession = () => {
  ...
  const [noteTabs, setNoteTabs] = useState<NoteTab[]>([{ id: "1", title: "Untitled 1", templateId: "", content: "" }]);
  ...
  const hasContent =
    contextContent.trim().length > 0 || transcriptContent.trim().length > 0 || dictationContent.trim().length > 0;
