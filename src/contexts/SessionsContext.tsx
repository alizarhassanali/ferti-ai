...
const defaultSessions: Session[] = [
  {
    ...
    date: new Date("2025-12-03T22:45:00"),
    time: "10:45PM",
    language: "English",
    duration: 0,
    status: "draft",
  ...
  },
  {
    ...
    date: new Date("2025-12-03T17:36:00"),
    time: "5:36PM",
    language: "English",
    duration: 312,
    status: "complete",
  ...
  },
  {
    ...
    patientId: "p1",
    patientName: "John Smith",
    patientDetails: "Follow-up visit",
    ...
    hasNotes: true,
    mode: 'transcribe',
    contextContent: 'Follow-up for lower back pain',
    transcriptContent: "Follow-up appointment for back pain management.",
    dictationContent: '',
    inputLanguage: 'en',
    outputLanguage: 'en',
    notes: []
